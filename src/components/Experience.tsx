  ...
  return (
    <div className="flex flex-col w-[60%] max-lg:w-full">
        ...
        <div className="flex flex-col w-full justify-center items-start pt-16 gap-4 p-4 max-lg:items-center rounded-xl max-md:gap-4 ">
            <h1 className="text-white text-7xl font-bold 2xl:text-8xl max-md:text-4xl">MY</h1>
            <h1 className="text-white/20 text-7xl font-bold 2xl:text-8xl max-md:text-4xl">EXPERIENCE</h1>
