  ...
  return (
    <div className="flex flex-col w-[60%] h-full max-lg:w-full">
          ...
          <div className="flex flex-col w-full h-full items-start pt-16 p-4 gap-5 max-lg:items-center">
            <h1 className="text-white text-7xl font-bold 2xl:text-5xl max-md:text-4xl">WEB</h1>
            <h1 className="text-white/30 text-7xl font-bold 2xl:text-5xl max-md:text-4xl">DEVELOPER</h1>
