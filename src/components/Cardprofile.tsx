...
function Cardprofile() {
  ...
  return (
    <div className="left-[10%] fixed flex w-1/4 h-screen justify-center items-center max-lg:hidden">
      <div className="profile-card flex w-full h-fit bg-white backdrop-blur-sm rounded-xl transition-transform duration-700">
      {/* Main Container */}
        ...
        {/* Profile Container */}
            ...
            <div className="flex flex-col w-full h-1/2 bg-white/10 backdrop-blur-sm rounded-xl gap-4 p-4 justify-around">
